      ...
      >
        ...
        <div style={{ display: "flex", justifyContent: "space-around" }}>
          <div style={{ display: "flex", flexFlow: "column" }}>
            <ul>
              <li>
                <a href="https://skytemple.org">SkyTemple</a>, 
                a tool to make ROMhacks of Pokémon Mystery Dungeon: Explorers of Sky
              </li>
              <li>
                <a href="https://projectpokemon.org/home/files/file/4235-skytemple-randomizer/">
                  SkyTemple Randomizer
                </a>,
                a program that randomizes all of the Pokémon in Explorers of Sky.
              </li>
              <li>
                <a href="https://github.com/audinowho/PMDODump">PMDO</a>, 
